...
<body style="background-color:#FEF5ED">
    <div class="container">
        <h1>คำสั่งแต่งตั้ง | 
            <a href='newdocuments.php'><span class='glyphicon glyphicon-plus' style="color:#F999B7"></span></a> 
            <a href='staff.php'><span class='glyphicon glyphicon-user' style="color:#F999B7"></span></a> 
            <a href='selectdocuments.php'><span class='glyphicon glyphicon-search' style="color:#F999B7"></span></a>
        </h1>
        <form action="#" method="post">
            <input type="text" name="kw" placeholder="ใส่เลขที่/ชื่อคำสั่ง" value="" size=40 >
            <button type="submit" class="glyphicon glyphicon-search btn btn-info" style="background-color:#F65C78"></button>
        </form>
        ...
        if ($result->num_rows == 0) {
            ...
            while($row = $result->fetch_object()){ 
                ...
                $table.= "<td>";
                $table.= "<a href='editdocuments.php?id=$row->id'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>";
                $table.= " | ";
                $table.= "<a href='deletedocuments.php?id=$row->id'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
                $table.= "</td>";
                $table.= "<td>";
